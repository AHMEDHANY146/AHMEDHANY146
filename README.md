...
<h3 align="center">📊 Data Scientist | 🤖 AI Automation Engineer | 🧠 Machine Learning Specialist</h3>
...
- 🛠️ Proficient in Python, JavaScript, and tools like PyTorch, scikit-learn, and Pandas for building data-driven solutions.
- 🚀 Experienced in deploying AI automation systems using FastAPI, LangChain, and OpenAI technologies.
- 🌐 Skilled in database management (PostgreSQL, MongoDB, Supabase) and cloud platforms (Vercel, Docker) for scalable applications.
